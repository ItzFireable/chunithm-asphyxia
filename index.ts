...
export const register = async () => {
    ...
    R.Config('title_hostname', {
        type: 'string',
        default: '',
        desc: 'Hostname or IP sent to cabinets as the title server address. Leave blank to use naominet.jp (for segatools setups). Set to your server IP for unmodified cabinets.',
    });
    ...
    R.SegaMethodNames([
        ...
        'GetUserMapApi', 'GetUserMapArea', 'GetUserMapAreaCondition',
        'GetUserCourse',
        ...
        'GetUserRivalDataApi', 'GetUserRivalMusicApi',
        ...
        'GetUserRecMusicApi', 'GetUserRecRatingApi',
